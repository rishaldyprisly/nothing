        ...
        function getAssets() {
            ...
            xmlHttp.onreadystatechange = function stateChanged() {
                if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
					...
					var tableRows = "<tr><th>Device</th><th>Name</th><th>Location</th><th>RSSI</th><th>Reader</th><th>Address</th><th>Type</th></tr>";
					...
					<?php 
					  ...
					  $data = mysqli_query($con, "SELECT * FROM registered WHERE MAC = [+assets[i]]["address"]") or die (mysqli_error());
...
<body onload="start()" style="text-align: center; background-color: #ffffff;">
	<img src="logo.png" width="250">
	<div style="font-size:12px; margin-left: 4.7em; margin-top:-.5em;"></div>
